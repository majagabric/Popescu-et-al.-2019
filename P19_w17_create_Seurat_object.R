...
##### Save Seurat object #####
saveRDS(seurat_obj_w17, file="P19_w17_seurat_obj.rds")

##### Load Seurat object #####
seurat_obj_w17 <- readRDS('/Users/majagabric/Documents/PhD/Data analysis/Popescu et al., 2019/Popescu et al., 2019/P19_w17_seurat_obj.rds')
