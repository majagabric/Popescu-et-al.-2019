...
##### Save Seurat object #####
saveRDS(seurat_obj_w7, file="P19_w7_seurat_obj_preQC.rds")

##### Load Seurat object #####
seurat_obj_w7 <- readRDS('/Users/majagabric/Documents/PhD/Data analysis/Popescu et al., 2019/Popescu et al., 2019/P19_w7_seurat_obj_preQC.rds')
